...
const options = {
    key: fs.readFileSync(path.resolve('/home/ubuntu/paste/ssl/live/haste.msws.xyz/privkey.pem')),
    cert: fs.readFileSync(path.resolve('/home/ubuntu/paste/ssl/live/haste.msws.xyz/fullchain.pem'))
};
